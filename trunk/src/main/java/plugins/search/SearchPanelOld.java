 ...
 */
public class SearchPanelOld extends JDialog {

	public static void main(String[] args) {
		SearchPanelOld searchPanel = new SearchPanelOld();
	 ...
	 */
	public SearchPanelOld(boolean selectStyles) {
	 ...
	 *            Parent frame.
	 */
	public SearchPanelOld(Frame owner) {
	 ...
	 *            If <TT>true</TT> bold and italic checkboxes displayed.
	 */
	public SearchPanelOld(Frame owner, boolean selectStyles) {
		super(owner, "Font Chooser", true);
	 ...
	 *            Parent frame.
	 */
	public SearchPanelOld(Dialog owner) {
		super(owner, "Font Chooser", true);
		_selectStyles = true;
		createUserInterface();
	}
	 ...
	 *            If <TT>true</TT> bold and italic checkboxes displayed.
	 */
	public SearchPanelOld(Dialog owner, boolean selectStyles) {
		super(owner, "Font Chooser", true);
		_selectStyles = selectStyles;
		createUserInterface();
	}
